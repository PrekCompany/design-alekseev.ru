      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
        <div className="md:col-span-7">
          <h1 className="text-5xl md:text-8xl font-black leading-tight mb-8">
            ...
            {/* Added animate-gradient-x and bg-size adjustment for flowing text effect */}
            <span className="uppercase text-transparentyb bg-clip-text bg-gradient-to-r from-white via-brand-neon to-brand-purple block opacity-0 animate-reveal-blur delay-200 filter drop-shadow-[0_0_10px_rgba(124,58,237,0.3)] bg-[length:200%_auto] animate-gradient-x">
              ALEKSEEV
            </span>
