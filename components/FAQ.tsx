...
=======
    answer: 'Сроки зависят от сложности. Брендинг обычно занимает 3-5 недель, корпоративный сайт — 4-8 недель. Мы предоставляем детальный график перед стартом.'
  },
  {
    question: 'Работаете ли вы со стартапами?',
    answer: 'Да, мы любим амбициозные стартапы. У нас есть специальные пакеты услуг для быстрого запуска MVP с качественным дизайном.'
  },
  {
    question: 'Какова ваша модель ценообразования?',
    answer: 'Мы работаем по проектной ставке (Fixed Price) для четких задач или по Time & Material для долгосрочной поддержки и развития продуктов.'
  },
  {
    question: 'Предоставляете ли вы постоянную поддержку?',
    answer: 'Безусловно. Мы предлагаем пакеты техподдержки и дизайн-сопровождения после запуска проекта.'
